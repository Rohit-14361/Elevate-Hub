...
const MentorCard = ({ mentor }) => {
  ...
  return (
    <Card
      ...
      hoverable
      className="w-80 h-80 flex flex-col rounded-full items-center justify-center shadow-md transition transform hover:scale-105 overflow-hidden"
    >
      <div className="relative group w-40 h-40 rounded-full overflow-hidden shadow-md overflow-hidden">
        <Avatar
          size={160}
          src={
